...
import com.example.ttwwapp.databinding.AnswerLayoutBinding
 ...
 class RecyclerAdapter(): RecyclerView.Adapter<RecyclerAdapter.Answer>() {
    ...
    class Answer(
        private val answerLayoutBinding: AnswerLayoutBinding,
        private val context: Context
    ) : RecyclerView.ViewHolder(answerLayoutBinding.root) {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Answer {
            val binding: AnswerLayoutBinding =
                AnswerLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        ...
        private val diffUtil: DiffUtil.ItemCallback<AnswerList> =
            object : DiffUtil.ItemCallback<AnswerList>() {
